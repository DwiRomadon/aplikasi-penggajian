	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
					...
					<a href="<?php echo base_URL()?>index.php/admin/arsip_penelitian/send/<?php echo $b->Kode?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i>Pilih</a>
