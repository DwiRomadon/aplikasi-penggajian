...
?>
   <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
		$q_cek	= $this->db->query("SELECT * FROM t_beasiswa WHERE idbeasiswa = '$idu'");
        ...
        if($j_cek == 1) {
           ?>
		   <tr>
			<td width="35%" height="28" bgcolor="#dff0d8">Bukti Untuk Beasiswa</td>
            <td width="65%" bgcolor="#dff0d8">: <?php echo $d_cek->tahunakademik ."-".$d_cek->semester ;} ?> </td>
		</tr>
       
	
	<form action="<?php echo base_URL()?>index.php/admin/buktibeasiswa/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		<table width="100%" class="table-form">
            ...
            <tr><td>Lampiran Bukti</td><td><select name="status" class="form-control" required><option value="">--</option>
			<option value='KTP' selected>KTP</option>
            <option value='KK' selected>Kartu Keluarga</option>
            <option value='Keterangan Lurah' selected>Keterangan Lurah</option>
            <option value='Surat Perpanjangan' selected>Surat Perpanjangan</option>
		   </select>
			</td></tr>
