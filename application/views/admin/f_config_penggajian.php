    ...
    <div class="col-xs-12">
        <div class="panel">
            ...
            <div class="panel-body table-responsive">
                ...
                <form method="post" action="<?php echo base_URL(); ?>index.php/admin/form_penggajian_submit/gaji_karyawan" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
