    ...
    <div class="col-xs-12">
        <div class="panel">
            ...
            <div class="panel-body table-responsive">
                ...
                <form method="post" action="<?php echo base_URL(); ?>index.php/sendMail" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
                    <div class="row-fluid well" style="overflow: hidden; height: 540px;">
                        ...
                        <div class="col-lg-10">
                            <table width="84%" class="table-form">
                                ...
                                <tr>
                                <tr><td colspan="6">
                                        <br><button type="submit" class="btn btn-primary pull-right" tabindex="9" ><i class="icon icon-ok icon-white"></i> Kirim Email</button>
                                    </td></tr>
