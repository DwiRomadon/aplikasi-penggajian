                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Detail Belum di Verifikasi</b> <br>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
            <td><?php echo $no;?></td>
            <td><?php echo $npmhs;?></td>
            <td><?php echo $nama;?></td>
            <td><?php echo $b->nlakhtrnlm;?> / <?php echo $b->bobottrnlm;?></td>
            <td><a href="<?php echo base_URL()?>index.php/admin/arsip_detailverifikasi/edtsetuju/<?php echo $b->kdmktrnlm;?>/<?php echo $tabelnya;?>/<?php echo $npmhs;?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setuju</a></td>
