...
<?php }  ?>
			...
			<td class="ctr">
				...
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/arsip_pendidikanadmin/edtsetuju/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setuju</a>
					<a href="<?php echo base_URL()?>index.php/admin/arsip_pendidikanadmin/edttdksetuju/<?php echo $b->id?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
