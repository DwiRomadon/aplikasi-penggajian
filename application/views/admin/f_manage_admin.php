...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">	
	 ...
	 <td>
         <select id="unit" name="unit" required class="form-control" style="width: 300px" >
         <option value="">Silahkan Pilih</option>
         <?php 
		 
		 $datax		= $this->db->query("SELECT * FROM t_unit")->result();
		if (empty($datax)) {
   ...
   <option value="<?php echo $b->unit?>"><?php echo $b->unit?></option>
<?php }  ?>
