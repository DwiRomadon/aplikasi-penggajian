...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
            ...
            <td><font color="<?php echo $warna ?>"><a href="<?php echo base_URL()?>index.php/admin/arsip_pembayaran/view/<?php echo $b->idbayar?>" class="btn btn-info btn-sm"><i class="icon-print icon-white"> </i> View </a></td>
