...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		?>
		<tr>
            <td><font color="<?php echo $warna ?>"><?php echo $b->npm ?></td>
	...
	<thead>
        ...
        <?php 
		 ...
		 $datam		= $this->db->query("SELECT * FROM t_pengabdianmhsfile WHERE idpengabdianmhs = '$b->id' AND npm = '$b->npm' ")->result();
		if (empty($datam)) {
...
<?php }  ?>
			...
			<td class="ctr">
				...
				?>
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/arsip_pengabdianmhsadmin/edtsetuju/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setuju</a>
					<a href="<?php echo base_URL()?>index.php/admin/arsip_pengabdianmhsadmin/edttdksetuju/<?php echo $b->id?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
