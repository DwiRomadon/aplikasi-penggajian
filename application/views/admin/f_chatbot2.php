...
$l_cek	= $this->db->query("SELECT * FROM t_mahasiswa WHERE username = '$username'");
		$k_cek	= $l_cek->num_rows();
		$t_cek	= $l_cek->row();
    ...
    <div class="col-md-12 col-lg-6">
    			...
    			<div class="panel-control">
    				<div class="btn-group">
    					...
    					<ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="<?php echo base_URL()?>index.php/admin/chatbot/del">Clear Chat</a></li>
    					</ul>
    				</div>
    			</div>
    			<h3 class="panel-title">BIANCA</h3>
    		</div>
    			...
    			<div class="nano has-scrollbar" style="height:380px">
    				<div class="nano-content pad-all" tabindex="0" style="right: -17px;">
    					<ul class="list-unstyled media-block">
    						<?php 
		$data	= $this->db->query("SELECT * FROM t_pesan WHERE npm = '$npm' ORDER BY tgl ASC  ")->result();
		if (empty($data)) {
        ...
        <li class="mar-btm">
    							<div class="media-left">
    								<img src="<?php echo base_url(); ?>upload/foto_profil/<?php echo $photo; ?>" class="img-circle img-sm" alt="Profile Picture">
    							</div>
    							<div class="media-body pad-hor">
    								<div class="speech">
    									<a href="#" class="media-heading"><?php echo $this->session->userdata('admin_nama')?></a>
    									<p> <?php echo $b -> tanya ; ?></p>
    									<p class="speech-time">
    									<i class="fa fa-clock-o fa-fw"></i><?php echo $b -> tgl ; ?>
    									</p>
    								</div>
    							</div>
    						</li>
		...
		$q_cek	= $this->db->query("SELECT * FROM t_setkey WHERE keyword = '$pecah[$x]'  ");
      ...
      <li class="mar-btm">
    							<div class="media-right">
    								<img src="<?php echo base_url(); ?>upload/foto_profil/bianca.jpg" class="img-circle img-sm" alt="Profile Picture">
    							</div>
    							<div class="media-body pad-hor speech-right">
    								<div class="speech">
    									<a href="#" class="media-heading">BIANCA</a>
    									<p><?php echo $jawabbianca ; $jawabbianca = ""?></p>
    									<p class="speech-time">
		 ...
		 ?>
    			...
    			<div class="panel-footer">
                    ...
                    <input type="hidden" name="id" value="<?php echo $idp; ?>">
    					...
    					<div class="col-xs-9">
    						<input type="text" name='pesana' placeholder="Enter your text" class="form-control chat-input">
    					</div>
    					<div class="col-xs-3">
