                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Daftar Matakuliah Belum di Verifikasi</b> <br>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
            <td><?php echo $no;?></td>
            <td><a href="<?php echo base_URL()?>index.php/admin/arsip_detailverifikasi/lihat/<?php echo $b->kdmktrnlm;?>/<?php echo $namatabel;?>" class="btn btn-success btn-sm"> <?php echo $b->kdmktrnlm;?></a></td>
