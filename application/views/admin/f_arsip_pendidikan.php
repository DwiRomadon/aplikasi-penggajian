...
?>
   <div class="row">
	...
	<form action="<?php echo base_URL()?>index.php/admin/arsip_pendidikan/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
	...
	<div class="col-lg-10">
        ...
        <tr>
          ...
          <td  ><a href="<?php echo base_URL()?>index.php/admin/klas_pilihpendidikan"><img src="<?php echo base_url(); ?>aset/img/places_ic_search.png" width="44" height="36" /></a></td>
          </tr>
