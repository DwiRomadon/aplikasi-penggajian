<?php $username = $this->session->userdata('admin_user'); ?>
   ...
   <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Lihat Data Transkrip Mahasiswa  </b>
	...
	<form action="<?php echo base_url(); ?>/index.php/admin/cetaktranskrip" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
