<?php $username = $this->session->userdata('admin_user'); ?>
   ...
   <div class="row">
	...
	<form action="<?php echo base_url(); ?>/index.php/admin/arsip_jumlahabsen/prodi" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
		...
		<table width="84%" class="table-form">
          ...
          <tr>
             ...
             <tr>
              <td>Tanggal</td>
              <td colspan="2"> Dari 
              <input type="date" name="tanggalawal" id="date" class="form-control" > Sampai <input type="date" name="tanggalakhir" id="date" class="form-control" >  </td></tr>
