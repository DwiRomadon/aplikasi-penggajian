	...
	<div class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">Komponen Prestasi Akademik</a>
			</div>
	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
					...
					<a href="<?php echo base_URL()?>index.php/admin/arsip_pendidikan/send/<?php echo $b->Kode?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i>Pilih</a>
