<?php $username = $this->session->userdata('admin_user'); ?>
   ...
   <div class="row">
	...
	<form action="<?php echo base_url(); ?>/index.php/admin/arsip_pengabdianmhsadmin/semslrh" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
	...
	<div class="col-lg-10">
		...
		<a href="<?php echo base_URL()?>index.php/admin/admin" tabindex="10" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
