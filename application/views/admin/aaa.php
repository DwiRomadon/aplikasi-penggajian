...
<head>
    <meta charset="UTF-8">
    <title>Digital Student Service</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta name="description" content="Hakko Bio Richard">
    <meta name="keywords" content="Perpus, Website, Aplikasi, Perpustakaan, Online">
    <!-- bootstrap 3.0.2 -->
    <link href="<?php echo base_url(); ?>/template/css/bootstrap.css" rel="stylesheet" type="text/css" />
    <!-- font Awesome -->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo $this->session->userdata('admin_nama'); ?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                <li class="dropdown-header text-center">Account</li>
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/admin/gantilahphoto">
                                        <i class="fa fa-camera fa-fw pull-right"></i>
                                            Ganti Photo
                                        </a>
                                        </li>
...
$logout_redirect_url = "index.php/admin/login"; // Set logout URL
...
?>
		...
		?>
                                    <center><a href="<?php echo base_url(); ?>index.php/admin/gantilahphoto"><img src="<?php echo base_url(); ?>upload/foto_profil/<?php echo $d_cek->photo;} ?>" height="80" width="80" class="img-circle" alt="User Image" style="border: 3px solid white;" /></a></center>
                                </div>
                                <div class="info">
                                    <center><p> <?php echo $this->session->userdata('admin_nama');?></p></center>
 ...
 <?php $this->load->view('admin/'.$page); ?>
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy UBL Apps</a> 2017
                </div>
            </aside><!-- /.right-side -->
        ...
        <!-- Bootstrap -->
        <script src="<?php echo base_url(); ?>/template/js/bootstrap.js" type="text/javascript"></script>
        <!-- daterangepicker -->
