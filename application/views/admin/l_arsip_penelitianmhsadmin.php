...
<table class="table table-bordered table-hover">
	...
	<thead>
        ...
        <?php 
		 ...
		 $datam		= $this->db->query("SELECT * FROM t_penelitianmhsfile WHERE idpenelitianmhs = '$b->id' AND npm = '$b->npm' ")->result();
		if (empty($datam)) {
...
<?php }  ?>
			...
			<td class="ctr">
				...
				?>
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/arsip_penelitianmhsadmin/edtsetuju/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setuju</a>
					<a href="<?php echo base_URL()?>index.php/admin/arsip_penelitianmhsadmin/edttdksetuju/<?php echo $b->id?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
