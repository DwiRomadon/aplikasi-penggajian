    ...
    <div class="col-xs-12">
        <div class="panel">
            <header class="panel-heading">
                <b>Potongan dan Pinjaman Karyawan</b>
                <div class="text-right" style="margin-top: 10px;">
                    <a href="<?php echo base_URL(); ?>index.php/admin/setPotonganFix/tabel_pootongan" class="btn btn-sm btn-info">Refresh<i class="fa fa-refresh"></i></a>
...
<div class="panel-body table-responsive">
    <div class="box-tools m-b-15">
        <form action="<?php echo base_URL(); ?>index.php/admin/setPotonganFix/cari_tabel_pootongan" method="POST">
        ...
        <div class="col-lg-12">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="ctr">
                        <div class="btn-group">
                            <a href="<?php echo base_URL()?>index.php/admin/setPotonganFix/bayar_potongan/<?php echo $b->nik?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setting Potongan</a>
                        </div>
                        <?php $no++;
                        }
                        } ?>
