...
if ($mode == "edt" || $mode == "act_edt") {
	$act				= "act_edt";
	$idp				= $datpil->id;
	$idpendidikan		= $datpil->idpendidikan;
...
?>
   <div class="row">
	...
	<form action="<?php echo base_URL()?>index.php/admin/buktipendidikan/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
