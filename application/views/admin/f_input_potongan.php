...
<form action="<?php echo base_URL()?>index.php/admin/form_penggajian_submit/act_save_potongan" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <div class="row-fluid well" style="overflow: hidden; height: 450px;">
        ...
        <div class="col-lg-6">
            <table width="100%" class="table-form">
                ...
                <tr><td>Nama Potongan</td><td colspan="3">
