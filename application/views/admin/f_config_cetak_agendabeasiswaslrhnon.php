<?php $username = $this->session->userdata('admin_user'); ?>
   ...
   <div class="row">
	...
	<form action="<?php echo base_url(); ?>/index.php/admin/arsip_penelitianmhsadmin/semslrh" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frmpe">
