...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			{
				$tulisan = "<a href='".base_URL()."upload/arsip_akademik/".$b->file_info."' target='_blank'>"."Download File"."</a>";
			}
			?>
			...
			<td class="ctr">
				...
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/akademik/edt/<?php echo $b->kode_info?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
					<a href="<?php echo base_URL()?>index.php/admin/akademik/del/<?php echo $b->kode_info?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
