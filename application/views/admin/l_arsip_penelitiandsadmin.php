                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <b>Tulisan Merah menandakan postingan anda belum di verifikasi</b>
                                    ...
                                    <form action="<?php echo base_URL(); ?>index.php/admin/arsip_penelitiands/cari" method="POST">
...
<table class="table table-bordered table-hover">
	...
	<thead>
        ...
        <?php 
		 ...
		 $datam		= $this->db->query("SELECT * FROM t_penelitiandsfile WHERE idpenelitiands = '$b->id' AND nidn = '$b->nidn' ")->result();
		if (empty($datam)) {
  ...
  <tr>
                ...
                <td><?php echo $l->status?></td>
                 <td class="ctr">
			<a href="<?php echo base_URL()?>index.php/admin/buktipenelitiands/view/<?php echo $l->id?>" class="btn btn-info btn-sm"><i class="icon-print icon-white"> </i> View </a>
			</td>
...
<?php }  ?>
			...
			<td class="ctr">
				...
				<div class="btn-group">
					<a href="<?php echo base_URL()?>index.php/admin/arsip_penelitiandsadmin/edtsetuju/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Setuju</a>
					<a href="<?php echo base_URL()?>index.php/admin/arsip_penelitiandsadmin/edttdksetuju/<?php echo $b->id?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda Yakin..?')">
