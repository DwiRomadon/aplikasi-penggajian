...
<form action="" method="post" id="form">
	<table class="table" width="60%">
		...
		<tr>
			...
			<td>:</td>
			<td>
				<input type="radio" name="tugas1" value="Yayasan Administrasi Lampung" <?php if($te['tugas_tambahan'] =='Yayasan Administrasi Lampung'){echo 'checked';}?>>Yayasan Administrasi Lampung<br>
				<input type="radio" name="tugas1" <?php if($te['tugas_tambahan'] =='Pimpinan Universitas'){echo 'checked';}?>>Pimpinan Universitas<br>
                    	...
                    	<input type="radio" name="tugas1" value="BIRO" <?php if($te['tugas_tambahan'] =='BIRO'){echo 'checked';}?>>BIRO<br>
                   		...
                   		<input type="radio" name="tugas1" value="Unit Pelaksana Teknis" <?php if($te['tugas_tambahan'] =='Unit Pelaksana Teknis'){echo 'checked';}?>>Unit Pelakasana Teknis<br>
                   ...
                   <input type="radio" name="tugas1" value="Laboratorium" <?php if($te['tugas_tambahan'] =='Laboratorium'){echo 'checked';}?> >Laboratorium<br>
                	...
                	<input type="radio" name="tugas1" value="Tidak ada tugas tambahan" <?php if($te['tugas_tambahan'] =='Tidak ada Tugas Tambahan'){echo 'checked';}?>>Tidak ada Tugas Tambahan<br>
		...
		<tr>
			...
			<td>
				<select name='golongan' class="form-control" >
						...
						<option <?php if( $te['golongan']==''){echo "selected"; } ?> value=''><?php echo $te['golongan']; ?></option>
						<option <?php if( $te['golongan']=='Penata Muda III/A'){echo "selected"; } ?> value='Penata Muda III/A'>Penata Muda III/A</option>
						<option <?php if( $te['golongan']=='Penata Muda III/B'){echo "selected"; } ?> value='Penata Muda III/B'>Penata Muda III/B</option>
		...
		<tr>
			<td colspan="3"><a href="index.php">Back To home</a></center>
			</td>
		</tr>
	</table>
